...
#define TCFG_CODE_FLASH_ENABLE											0


#define STYLE_JL_NULL              	(1)
#define STYLE_JL_WTACH              (2)//彩屏demo
#define STYLE_JL_WTACH_NEW          (3)//彩屏demo
#define STYLE_JL_SOUNDBOX           (4)//点阵屏demo
...
//enable dut mode,sleep mode should be disable
...
#define CONFIG_BT_RX_BUFF_SIZE  (8 * 1024)
...
#elif (defined(CONFIG_CPU_BR28))
#define CONFIG_BT_TX_BUFF_SIZE  (16 * 1024)
#endif
#endif
