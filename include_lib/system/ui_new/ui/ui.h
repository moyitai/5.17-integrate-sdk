...
int ui_page_switch(int curr_win, int next_win, int xoffset, int yoffset);
...
void ui_draw_ring(void *_dc, int x, int y, int radius_big, int radius_small, int angle_begin, int angle_end, int color);
