...
#define P3_ANA_CON14_RV				0b00001100
...
/************************P3_PVDD0_AUTO*****************************/
#define PVDD_VOL_MIN            	900//mV
#define PVDD_VOL_STEP           	50 //mV
#define PVDD_VOL_LOW 				800 //mv, 如果出现异常, 可以抬高该电压值
#define PVDD_LOW_LEVEL 				((PVDD_VOL_MIN - PVDD_VOL_LOW) / PVDD_VOL_STEP)
