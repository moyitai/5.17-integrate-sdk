#ifndef CONFIG_BOARD_7012A_DEMO_POST_BUILD_CFG_H
#define CONFIG_BOARD_7012A_DEMO_POST_BUILD_CFG_H
...
#define CONFIG_EXTERN_USER_VM_FLASH_SIZE        (128*1024)  //配置外挂FLASH大小
...
#define CONFIG_SUPPORTED_CHIP_VERSION			A,B,M,N,O,P
