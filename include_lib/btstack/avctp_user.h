...
typedef enum {
    ...
    BT_STATUS_ENCRY_COMPLETE,        /*加密完成*///8
    ...
    BT_STATUS_RESUME,           /*后台有效，手动切回蓝牙*///--20
    ...
    BT_STATUS_BT_TEST_BOX_CMD,              /*蓝牙收到测试盒消息。1-升级，2-fast test*///30
    BT_STATUS_BT_TWS_CONNECT_CMD,
    BT_STATUS_SNIFF_STATE_UPDATE,              /*SNIFF STATE UPDATE*///32
